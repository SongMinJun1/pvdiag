...
DEFAULT_READINESS_ARTIFACT = "capture_readiness_packet"
DEFAULT_MANIFEST_SUMMARY_ARTIFACT = "package_manifest_summary"
...
def main() -> None:
    ...
    parser.add_argument("--readiness-input", default="")
    parser.add_argument("--manifest-summary-input", default="")
    parser.add_argument("--output-dir", default=DEFAULT_OUTPUT_DIR)
    args = parser.parse_args()

    repo_root = Path(args.repo_root).resolve()
    readiness_input = resolve_capture_chain_dependency(
        repo_root,
        args.readiness_input,
        DEFAULT_READINESS_ARTIFACT,
        args.capture_chain_manifest,
    )
    manifest_summary_input = resolve_capture_chain_dependency(
        repo_root,
        args.manifest_summary_input,
        DEFAULT_MANIFEST_SUMMARY_ARTIFACT,
        args.capture_chain_manifest,
    )
