...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "BR-059 fault-family regression prepatch gate."
        )
    )
...
def build_summary(detail: pd.DataFrame, panel_row: dict[str, object], fault_row: dict[str, object]) -> pd.DataFrame:
...
def main() -> None:
    ...
    summary = build_summary(detail, panel_row, fault_row)
