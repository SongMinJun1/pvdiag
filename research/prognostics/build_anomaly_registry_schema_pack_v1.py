...
ENTITY_SPECS: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "fields": [
            ...
            field("shape_flag", "boolean", "derived", 1, "derived", "forbidden", "shape anomaly 여부"),
            field("shape_score", "float", "derived", 1, "derived", "allowed_when_unavailable", "shape anomaly 점수"),
            field("instability_flag", "boolean", "derived", 1, "derived", "forbidden", "instability 여부"),
            field("instability_score", "float", "derived", 1, "derived", "allowed_when_unavailable", "instability 점수"),
    ...
    },
    {
        ...
        "fields": [
            ...
            field("has_shape_anomaly", "boolean", "derived", 1, "derived", "forbidden", "shape anomaly 포함 여부"),
            field("has_instability", "boolean", "derived", 1, "derived", "forbidden", "instability 포함 여부"),
    ...
    },
    {
        ...
        "fields": [
            field("strict_case_id", "string", "foreign_key", 1, "derived", "forbidden", "strict case 참조 ID"),
            ...
            field(
                ...
                notes="local evidence와 incident membership이 함께 존재할 수 있어 role이 필요하다.",
            ),
            field(
                "mapping_confidence",
                "string",
    ...
    },
    {
        ...
        "fields": [
            ...
            field(
                ...
                "forbidden",
                "source node 타입",
                notes="허용값은 panel_local_episode 또는 common_cause_incident다.",
            ),
            ...
            field(
                ...
                notes="relation edge는 typed edge일 뿐 automatic merge나 same cause를 뜻하지 않는다.",
            ),
            field(
                "claim_level",
                "string",
...
ENUM_SPECS: dict[str, list[tuple[str, str]]] = {
    "strict_source": [
        ...
        ("manual_truth_seed", "수동 truth seed에서 만든 strict 행"),
        ("vendor_review_seed", "vendor review seed에서 만든 strict 행"),
    ],
    "dominant_local_family": [
        ...
        ("shadow_like", "shadow-like 패턴이 지배적임"),
        ("group_off_like", "group-off-like 패턴이 지배적임"),
    ...
    "membership_role": [
        ("primary_local_member", "주된 local episode 멤버"),
        ("secondary_local_member", "보조 local episode 멤버"),
        ("incident_only_member", "incident에만 직접 연결됨"),
        ("overlap_local_and_incident", "local episode와 incident에 동시에 걸침"),
        ("unmapped_strict_case", "어느 target에도 매핑되지 않음"),
    ],
    "relation_type": [
        ...
        ("shared_group_proxy", "group proxy가 공유됨"),
        ("same_panel_history_link", "패널 이력상 연결만 존재함"),
    ],
    "claim_level": [
        ("observed", "직접 관측된 연결"),
        ("derived_rule", "규칙으로 유도된 연결"),
        ("review_hypothesis", "검토용 가설 연결"),
        ("future_optional", "미래 구현에서만 채울 수 있는 연결"),
    ],
    "relation_direction": [
        ("undirected", "방향성 없음"),
...
REASON_CODES: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "notes": "membership_role로 mixed membership을 분리한다.",
    },
    {
...
CONFIG_KEYS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "caution_ko": "운영 default와 schema freeze는 분리된다.",
    },
    {
    ...
    },
    {
        ...
        "caution_ko": "lead window 기본값은 provisional이다.",
    },
]
