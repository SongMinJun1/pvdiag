...
def main() -> None:
    ...
    explicit_flags = {
        flag for flag in ["--gap-review-input"] if cli_flag_provided(flag, sys.argv[1:])
    }
    gap_review_path, gap_review_source = resolve_chain_input(
        base_root,
    ...
    gap_review = read_gap_review(gap_review_path)
    ...
    write_note(
        ...
        gap_review_path,
        input_manifest_path,
        {"gap_review_input": gap_review_source},
    )
