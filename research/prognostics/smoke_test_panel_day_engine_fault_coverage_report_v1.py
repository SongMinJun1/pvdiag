...
OUTPUT_COVERAGE = REPO_ROOT / "_share/panel_day_engine_fault_coverage_matrix_v1.csv"
OUTPUT_METRICS = REPO_ROOT / "_share/panel_day_engine_model_metrics_v1.csv"
OUTPUT_DOC = REPO_ROOT / "docs/OPS_FAULT_COVERAGE_AND_MODEL_PERFORMANCE_V1.md"
