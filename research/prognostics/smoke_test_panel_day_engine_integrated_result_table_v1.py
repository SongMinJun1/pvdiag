...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="integrated_result_table_smoke_") as tmp_dir:
        ...
        with stage_missing_share_fixtures(
            ...
            output_table = tmp_root / "_share/panel_day_engine_integrated_result_table_v1.csv"
            output_summary = tmp_root / "_share/panel_day_engine_integrated_result_summary_v1.csv"
