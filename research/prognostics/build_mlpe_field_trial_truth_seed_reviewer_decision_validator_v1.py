...
DEFAULT_SCHEMA = "/private/tmp/mlpe_field_trial_truth_seed_reviewer_decision_schema_br121_check/mlpe_field_trial_truth_seed_reviewer_decision_schema_v1.csv"
DEFAULT_ALLOWED_VALUES = "/private/tmp/mlpe_field_trial_truth_seed_reviewer_decision_schema_br121_check/mlpe_field_trial_truth_seed_reviewer_decision_allowed_values_v1.csv"
...
def main() -> None:
    ...
    decision_path = resolve_path(repo_root, args.decision_input)
