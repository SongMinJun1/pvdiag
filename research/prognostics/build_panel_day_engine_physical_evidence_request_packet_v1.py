...
def main() -> None:
    ...
    confirmation_path, confirmation_source = resolve_chain_input(
        base_root,
        args.confirmation_input,
        DEFAULT_CONFIRMATION_INPUT,
        input_manifest,
        "confirmation_input",
        "--confirmation-input",
        explicit_flags,
    )
    checklist_path, checklist_source = resolve_chain_input(
        base_root,
        args.checklist_input,
        DEFAULT_CHECKLIST_INPUT,
        input_manifest,
        "checklist_input",
        "--checklist-input",
        explicit_flags,
    ...
    input_resolution_sources = {
        "confirmation_input": confirmation_source,
        "checklist_input": checklist_source,
    }

    confirmation = read_csv(confirmation_path)
    ...
    write_note(args.output_dir, requests, summary, input_manifest_path, input_resolution_sources)
