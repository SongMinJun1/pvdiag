...
DEFAULT_RUNBOOK_DIR_ARTIFACT = "real_label_intake_runbook_dir"
...
def main() -> None:
    ...
    parser.add_argument("--runbook-dir", default="")
    parser.add_argument("--output-dir", default=DEFAULT_OUTPUT_DIR)
    args = parser.parse_args()

    repo_root = Path(args.repo_root).resolve()
    runbook_dir = resolve_truth_intake_chain_dependency(
        repo_root,
        args.runbook_dir,
        DEFAULT_RUNBOOK_DIR_ARTIFACT,
