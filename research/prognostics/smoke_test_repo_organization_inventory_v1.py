...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="repo_org_inventory_") as tmp_dir:
        ...
        assert_true("runtime_bundle_boundary" in set(lane_df["cleanup_lane"]), lane_df.to_string())
        assert_true("mixed_scope_disentangle" in set(lane_df["cleanup_lane"]), lane_df.to_string())
