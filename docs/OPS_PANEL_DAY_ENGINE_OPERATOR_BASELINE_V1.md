...
- 이번 확장도 baseline attention 규칙을 바꾸는 것이 아니라, 이미 승인된 discovery preview/delta stack과 unified digest consumer view를 baseline rebuild 시 함께 갱신하도록 묶는 packaging change다.
