...
python3 research/prognostics/build_mlpe_field_trial_artifact_mlpe_control_clearance_contract_v1.py --repo-root "$(pwd)" --output-dir /private/tmp/mlpe_field_trial_artifact_mlpe_control_clearance_contract_br135_check
```
