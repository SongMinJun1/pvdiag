...
### 3) `data/kernelog1/out/panel_day_risk_ensemble.csv`
- 이 파일이 답하는 질문:
...
3. `panel_day_risk_ensemble.csv`에서 같은 날짜의 상위 랭크 후보 확인
4. `panel_day_risk_transition.csv`로 transition 점수와 순위 차이 비교
