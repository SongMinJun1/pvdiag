...
python3 research/prognostics/build_mlpe_field_trial_commit_scope_dry_run_audit_v1.py --repo-root "$(pwd)" --output-dir /private/tmp/mlpe_field_trial_commit_scope_dry_run_br148_check
```
