...
python3 research/prognostics/build_mlpe_field_trial_real_capture_intake_contract_v1.py --repo-root "$(pwd)" --output-dir /private/tmp/mlpe_field_trial_real_capture_intake_contract_br129_check
```
