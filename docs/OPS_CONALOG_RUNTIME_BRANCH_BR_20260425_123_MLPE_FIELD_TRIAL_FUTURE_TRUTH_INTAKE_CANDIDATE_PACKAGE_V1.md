...
python3 research/prognostics/build_mlpe_field_trial_truth_seed_future_truth_intake_candidate_package_v1.py --repo-root "$(pwd)" --validation /private/tmp/mlpe_field_trial_truth_seed_reviewer_decision_validator_br122_check/mlpe_field_trial_truth_seed_reviewer_decision_validation_v1.csv --issues /private/tmp/mlpe_field_trial_truth_seed_reviewer_decision_validator_br122_check/mlpe_field_trial_truth_seed_reviewer_decision_validation_issues_v1.csv --output-dir /private/tmp/mlpe_field_trial_truth_seed_future_truth_intake_candidate_package_br123_check
```
