...
python3 research/prognostics/build_panel_day_engine_voltage_preserved_confirmation_gap_review_v1.py --repo-root "$(pwd)" --attachment-dir /private/tmp/panel_day_engine_voltage_preserved_raw_source_attachment_br096_check --vendor-input /Users/b9gc/pvdiag/data/manual/vendor_reply_cases.csv --manual-site-input docs/internal/manual_field_evidence_latest.csv --output-dir /private/tmp/panel_day_engine_voltage_preserved_confirmation_gap_review_br097_check
```
